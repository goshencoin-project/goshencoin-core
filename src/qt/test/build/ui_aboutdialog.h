...
"Copyright &copy; 2011-YYYY The Goshencoin developers"));
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About Goshencoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>Goshencoin</b> version", 0));
