...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Goshencoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"goshencoin.com", "dnsseed.goshencoin.com"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"goshencoin_test.com", "dnsseed.goshencoin_test.com"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Goshencoin is probably already running."), addrBind.ToString().c_str());
        else
